...
import { current, github, login, logout } from "../controller/session.controller.js";
...
routerSessions.post( "/register", passport.authenticate("register", { failureRedirect: "failregister" }),
  async (req, res) => {
